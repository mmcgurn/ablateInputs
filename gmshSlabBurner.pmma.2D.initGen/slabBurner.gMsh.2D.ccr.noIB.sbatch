...
export DM_REFINE=0
export TITLE=lowG-gMsh-4n-dm$DM_REFINE-noSootNoRad-$SLURM_JOBID
export FILE=/panasas/scratch/grp-chrest/mtmcgurn/ablateInputs/gmshSlabBurner.pmma.2D.initGenD/slabBurner2D.lowG.3_8_23.yaml
